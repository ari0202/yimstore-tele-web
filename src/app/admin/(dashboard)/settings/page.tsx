...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <form action={updateSettings} className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm space-y-8 mt-4">
        
        {/* General Info */}
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900 border-b pb-2">General</h2>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Telegram Testimonial Channel ID</label>
            <input 
              type="text" 
              ...
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" 
            />
            <p className="text-sm text-gray-500 mt-1">Leave empty to disable auto-posting testimonials.</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Max Orders Per Minute (Rate Limiter)</label>
            <input 
              type="number" 
        ...
        <section className="space-y-4 pt-4 border-t border-red-100">
          ...
          <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg flex items-start gap-4">
            <input 
              ...
              className="mt-1 h-4 w-4 text-orange-600 rounded border-orange-300 focus:ring-orange-500" 
            />
            <div>
              <label htmlFor="maintenance" className="font-semibold text-orange-800">Maintenance Mode</label>
              <p className="text-sm text-orange-700">Display "Under Maintenance" to all public visitors. Admin dashboard remains accessible.</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-4">
            ...
            />
            <div>
              <label htmlFor="killswitch" className="font-semibold text-red-800">Emergency Kill Switch</label>
              <p className="text-sm text-red-700">Instantly paralyze ALL checkout APIs and automated fulfillment webhooks to prevent large-scale exploits. Use during active attacks.</p>
            </div>
          </div>
        </section>
