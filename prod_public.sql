...
\restrict AGgMPnYsWqQw7oWOexJbzqWsZ7CE1yICfirygrOFBPxw80wzY7fle7O9GN9cpSJ
...
--
-- Name: rpc_bulk_insert_inventory(uuid, uuid, text[]); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION public.rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]) OWNER TO postgres;
...
--
-- Name: FUNCTION rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]) TO anon;
GRANT ALL ON FUNCTION public.rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]) TO authenticated;
GRANT ALL ON FUNCTION public.rpc_bulk_insert_inventory(p_admin_id uuid, p_product_id uuid, p_credentials_array text[]) TO service_role;
...
\unrestrict AGgMPnYsWqQw7oWOexJbzqWsZ7CE1yICfirygrOFBPxw80wzY7fle7O9GN9cpSJ
