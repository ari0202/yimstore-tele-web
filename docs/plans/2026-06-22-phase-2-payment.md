# Phase 2: Payment & Fulfillment Implementation Plan (v9)

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Mengimplementasikan backend Next.js untuk Checkout dan Webhook Pakasir. Arsitektur versi 9 (Final Form) menambahkan dukungan penuh untuk **Multi-Item Cart Fulfillments**, memelihara **Dead Letter Queue (Operations)**, dan mencegah **Idempotency State Locking** pada pembayaran yang diperbaiki.

---

### Task 1: Database Migration for All-Or-Nothing Fulfillment & Deadlock-Free Cleanup

**Files:**
- Create: `supabase/migrations/20260622100000_phase2_architecture.sql`

**Step 1: Migrasi Fungsi SQL (Deadlock-Free, Multi-Item, State-Machine Safe)**
```sql
...
git commit -m "feat: db logic for multi-item cart fulfillment, dead-letter outbox, and state machine recovery"
```

---

### Task 2: Initialize Next.js & Supabase Admin Client
*(Sama dengan rencana sebelumnya).*

---

### Task 3: Checkout API (Atomic Race-Condition Safe)
*(Sama dengan rencana sebelumnya).*

---

### Task 4: Webhook Listener (Payload-Hashing Idempotency)
*(Sama dengan rencana v8).*

---

### Task 5: Robust Outbox Processor
*(Sama dengan rencana v8: memanggil `process_payment_fulfillment` dengan pendelegasian atomic RPC, namun fungsionalitasnya kini telah sempurna melayani cart majemuk).*
