...
pm2 start /root/bot-tele-auto/balz.js --name "bot-tele-auto"
pm2 start /root/Akun/capcut-account-maker/src/bot.js --name "capcut-bot"
pm2 start n8n --name "n8n"
pm2 start npm --name "yimstore-web" --cwd /root/yimstore-tele-web -- start
pm2 start "npx tsx --env-file=.env src/bot-runner.ts" --name "telegram-bot" --cwd /root/yimstore-tele-web
